...
echo "MPI"
	mkdir 10p-mpi
	qsub sge-submit-mpi.csh Makeflow10 Makeflow10.debug
...
echo "WQ-MPI"
	mkdir 10p-wq-mpi
	qsub sge-submit-mpi-wq.csh Makeflow10 Makeflow10.debug
        while [ ! -f Makeflow10.makeflowlog ]
        do
		sleep 60
                echo "blah" > /dev/null
...
echo "MPI"
        mkdir 20p-mpi
        qsub sge-submit-mpi.csh Makeflow20 Makeflow20.debug
...
echo "WQ-MPI"
        mkdir 20p-wq-mpi
        qsub sge-submit-mpi-wq.csh Makeflow20 Makeflow20.debug
        while [ ! -f Makeflow20.makeflowlog ]
        do
		sleep 60
                echo "blah" > /dev/null
...
echo "MPI"
        mkdir 40p-mpi
        qsub sge-submit-mpi.csh Makeflow40 Makeflow40.debug
...
echo "WQ-MPI"
        mkdir 40p-wq-mpi
        qsub sge-submit-mpi-wq.csh Makeflow40 Makeflow40.debug
        while [ ! -f Makeflow40.makeflowlog ]
        do
		sleep 60
                echo "blah" > /dev/null
...
echo "MPI"
        mkdir 60p-mpi
        qsub sge-submit-mpi.csh Makeflow60 Makeflow60.debug
...
echo "WQ-MPI"
        mkdir 60p-wq-mpi
        qsub sge-submit-mpi-wq.csh Makeflow60 Makeflow60.debug
        while [ ! -f Makeflow60.makeflowlog ]
        do
		sleep 60
                echo "blah" > /dev/null
...
echo "MPI"
        mkdir 80p-mpi
        qsub sge-submit-mpi.csh Makeflow80 Makeflow80.debug
...
echo "WQ-MPI"
        mkdir 80p-wq-mpi
        qsub sge-submit-mpi-wq.csh Makeflow80 Makeflow80.debug
        while [ ! -f Makeflow80.makeflowlog ]
        do
		sleep 60
                echo "blah" > /dev/null
...
echo "MPI"
        mkdir 100p-mpi
        qsub sge-submit-mpi.csh Makeflow100 Makeflow100.debug
...
echo "WQ-MPI"
        mkdir 100p-wq-mpi
        qsub sge-submit-mpi-wq.csh Makeflow100 Makeflow100.debug
        while [ ! -f Makeflow100.makeflowlog ]
        do
		sleep 60
                echo "blah" > /dev/null
